 ...
 * → A 会话的告警横幅出现在 B，切会话也不清。sessionId=null → 不渲染。
 */
  ...
  return (
    ...
    <div className="retry-wrap">
      <div className="tw-banner" role="status">
        ...
        <button className="tw-close" onClick={() => { if (sessionId) useChatStore.getState().setTokenWarning(sessionId, null) }} aria-label="关闭">
