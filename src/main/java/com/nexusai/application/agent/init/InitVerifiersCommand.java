...
/**
 * /init-verifiers command · 对齐 CC commands/init-verifiers.ts.
 *
 * <p>CC source: commands/init-verifiers.ts (262 LOC).
 * Long structured prompt: 5 phases (Auto-Detection → Setup → Q&A → Generate → Confirm)
 * for creating verifier skills (verifier-playwright, verifier-cli, verifier-api).
 */
public final class InitVerifiersCommand {

    private static final Logger log = LoggerFactory.getLogger(InitVerifiersCommand.class);

    public static final String NAME = "init-verifiers";
    public static final String PROGRESS_MESSAGE = "analyzing your project and creating verifier skills";
    ...
    public static final String PROMPT = """
        ...
        **All verifier skills are created in the project root's `.nexusai/skills/` directory.** This ensures they are automatically loaded when Claude runs in the project.

        Write the skill file to `.nexusai/skills/<verifier-name>/SKILL.md`.
        ...
        **verifier-api**:
        ...
        1. Where each skill was created (always in `.nexusai/skills/`)
    ...
    public InitVerifiersCommand(Supplier<String> userTypeSupplier) {
        this.userTypeSupplier = Objects.requireNonNull(userTypeSupplier);
    }

    public String name() { return NAME; }
    public String description() {
        return "Create verifier skill(s) for automated verification of code changes";
    }
    ...
    public List<java.util.Map<String, Object>> getPromptBlocks() {
        return List.of(java.util.Map.of("type", "text", "text", getPrompt()));
    }
}
